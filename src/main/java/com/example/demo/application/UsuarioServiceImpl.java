...
public class UsuarioServiceImpl implements UsuarioPortIn {
    ...
    @Override
    public UsuarioModel buscarPorEmailIn(String email) {
        return null;
    }
    ...
    @Override
    public Optional<UsuarioModel> actualizarUsuario(int id, UsuarioModel usuarioModel) {
        return Optional.empty();
    }

    private void validarUsuario(UsuarioModel usuarioModel) {
